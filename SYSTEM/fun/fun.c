...
//rgbw2814[1]=1;  rgbw2814[2]=2;
 ...
 //	SPI3_WriteByte(Tx1Buf,100);//–¥OLED∆¡
//=======================CANÕ®–≈ ˝æ›================================================
 if((cantim>=5)&&(canytim>canno))
	{
		cantim=0;
	  CAN1_Send_Num(CANaddr,candata); //CAN∑¢ÀÕ ˝æ›
	}
...
// SPI1_RD();	
	...
	//◊¢“‚Ωÿ»° ±¥” ˝◊Èµ⁄“ªŒªø™ º£¨ ˝◊È“—æ≠’˚∫œ ˝æ›£¨
	OLEDtinct(Rx2Buf,rgbw2814,RGBWmultiple,24); //Ωÿ»°RGBWœ‘ æ ˝æ›
	
	temp1++;
	if(temp1>=500){LED2=!LED2;temp1=0;	}	//‘À––÷∏ æ
}
