...
#define dead_zoneL   570   //死区设置
#define dead_zoneH   0.38  //死区设置
...
{			
 if(ADC_Ch_cnt==0)  //摇杆X
 {
   ...
   if(ADC_out1<dead_zoneL)
   {
	 ...
	 if(ADC_out1>=dead_zoneL)
	 {
		 adctemp1=(float)ADC_out1-(float)dead_zoneL;
		 adctemp2=adctemp1*dead_zoneH+adctemp1;
