...
int st_app_output_sdi_init(struct st_app_context* ctx, st_json_context_t *json_ctx);
...
int st_tx_sdi_output_start(st_app_context *ctx, seeder::core::output *source);
