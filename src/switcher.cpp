...
void Switcher::execute_on_air_command(const nlohmann::json &command) {
  http_client->post("/api/mixer/update_keyer_params", command.dump());
}
//pgm pvw ket fill
